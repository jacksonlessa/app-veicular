...
- [x] 5.1 Criar `src/application/usecases/maintenance/get-maintenance.usecase.ts`
- [x] 5.2 Criar `src/application/usecases/maintenance/list-maintenances.usecase.ts`
- [x] 5.3 Criar `src/application/usecases/maintenance/delete-maintenance.usecase.ts`
- [x] 5.4 Escrever testes unitários para `GetMaintenanceUseCase`
- [x] 5.5 Escrever testes unitários para `ListMaintenancesUseCase`
- [x] 5.6 Escrever testes unitários para `DeleteMaintenanceUseCase`
- [x] 5.7 Rodar `npm test` verde
